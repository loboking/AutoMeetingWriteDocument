...
// Gemini File API 한도. 준의 File API 전환(15MB 초과 시 File API 분기, ab3614a) 머지 완료.
// 큰 파일(회의록 30-60분, 20-50MB)도 File API(2GB/9.5시간)로 처리 → 아래 한도 안내는 사실.
...
export const SHOW_FILE_LIMIT_HINT = true; // File API 전환 완료로 활성화
