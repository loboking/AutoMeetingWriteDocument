...
> 💡 **참고**: API 키 없이도 앱을 실행할 수 있지만, 실제 AI 기능을 사용하려면 키가 필요합니다. 개발용 모의 응답이 제공됩니다.
...
- **Anthropic Claude API** - AI 요약 및 PRD 생성
...
| `ANTHROPIC_API_KEY` | Anthropic API 키 (Claude용) | 선택* |

*선택사항이지만, 실제 AI 기능을 사용하려면 필요합니다. 없으면 모의 응답이 반환됩니다.
