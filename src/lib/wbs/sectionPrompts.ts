...
- 모든 마일스톤, 작업 시작일, 간트 차트는 **${currentYear}년 ${minStartDate} 이후**의 날짜로만 생성해야 합니다.
...
| 버전 | 날짜 | 변경 내용 | 작성자 |
|------|------|----------|--------|
| v1.0 | ${meetingInfo.date} | 초기 작성 | PM |
...
export const SECTION_PROMPTS: Record<string, SectionPrompt> = {
  ...
  'work-packages': workPackagesPrompt,
  'gantt-chart': ganttChartPrompt,
  'milestones': milestonesPrompt,
  'risks': risksPrompt,
  'resources': resourcesPrompt,
