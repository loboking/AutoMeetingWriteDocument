...
|-----------|--------|------|------|----------|--------|
| 비즈니스 | MAU | - | [구체적 수치] | [구체적 시점] | - |
| 비즈니스 | 전환율 | - | [구체적 수치] | [구체적 시점] | - |
| 제품 | 기능 완료도 | 0% | 100% | 출시 시 | 개발팀 |
| 제품 | 버그률 | - | 1% 이하 | 출시 1개월 후 | QA팀 |

**중요**: 회의에서 언급된 모든 수치를 반드시 포함하세요. 없으면 "TBD"라고 표시하세요.
`;
  },
...
| products | id, name, price, description, category | 1:N | 가변 | 주간 |
| orders | id, user_id, product_id, amount, status, created_at | N:1 | 100만건 | 주간 |
`;
  },
