    ...
    <PageContainer width="narrow" className="py-10 text-foreground">
      ...
      <section className="space-y-5 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p>서비스는 기능 제공을 위해 입력 데이터를 외부 AI/저장 서비스로 전송합니다. 상세는 <Link href="/privacy" className="text-primary underline">개인정보처리방침</Link>을 참고하세요.</p>
        </div>
        <div>
      ...
      <p className="mt-10 text-xs text-muted-foreground">시행일: 베타 운영 기간 · 본 약관은 정식 출시 전 변경될 수 있습니다.</p>
